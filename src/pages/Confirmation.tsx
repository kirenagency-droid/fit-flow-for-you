...
const Confirmation = () => {
  ...
  const features = [
    "Accès illimité à toutes nos salles Basic-Fit 24h/24 7j/7",
    "Cours collectifs en streaming",
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="bg-card border border-border rounded-2xl p-8">
                <h2 className="text-2xl font-bold text-foreground mb-6">Récapitulatif de votre offre</h2>
                ...
                <div className="space-y-6">
                  ...
                  {/* Avantages */}
                  <div>
                    <h3 className="font-bold text-foreground mb-4">Tout inclus :</h3>
            ...
            <div className="space-y-8">
              <div className="bg-card border-2 border-primary/20 rounded-2xl p-8">
                ...
                <div className="space-y-6">
                  ...
                  <Link 
                    to="/" 
                    className="flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors text-sm"
                  >
